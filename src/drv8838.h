...
public:
	...
	drv8838(uint8_t, uint8_t, uint8_t); //constructor that sets pins for board - enable, phase - enable should be PWM
	void configure(uint8_t, uint8_t); //manually sets pins for board - enable, phase - enable should be PWM
	void setDirection(boolean); //set motor direction
	void sleep(boolean); //set motor direction
